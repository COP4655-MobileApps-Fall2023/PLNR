...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    private enum Constants {
        ...
        static let dayNavigationControllerIdentifier = "DayNavigationController"
    ...
    private func login() {
        ...
        self.window?.rootViewController = storyboard.instantiateViewController(withIdentifier: Constants.dayNavigationControllerIdentifier)
    }
